 ...
 */
public class EnumerationPropertyConverter extends AbstractConverter {

    public EnumerationPropertyConverter() {
    }
    ...
    public Object convertFromString(HttpServletRequest request, String value) {
        ...
        if(enumeration == null) {
            throw new IllegalStateException("Enumeration not found: " + value);
        }
        return enumeration.getEnumerationReference();
