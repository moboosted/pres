 ...
 * @author Justin Walsh
 */
public class FormatSpecificationObjectNameTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (value instanceof StructuredActualDTO) {
            ...
            kind = s.getKind();
            defaultDisplayName = s.getDefaultDisplayName();
        }
        ...
        String output = getTypeFormatter().formatSpecificationObjectName(kind, defaultDisplayName);
