...
public class EnumerationPropertyRenderer extends AbstractPropertyRenderer {
    ...
    protected String formatPropertyValue(PageContext pageContext, Object propertyValue) {
        ...
        EnumerationReference enumerationReference = (EnumerationReference)propertyValue;
        ...
        IEnumeration enumeration = productDevelopmentService.getEnumeration(new ApplicationContext(), enumerationReference);
        if(enumeration == null) {
            return StringUtils.EMPTY;
        }
