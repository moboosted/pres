...
public class BigDecimalPropertyRenderer extends AbstractPropertyRenderer {

    public BigDecimalPropertyRenderer() {
    }
    ...
    protected String formatPropertyValue(PageContext pageContext, Object propertyValue) {
        ...
        return formatter.formatBigDecimal((BigDecimal) propertyValue);
    }
}
