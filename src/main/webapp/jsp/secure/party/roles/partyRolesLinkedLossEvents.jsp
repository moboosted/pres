...
<table class="party-table" width="100%">
    <logic:present name="partyForm" property="partyRoleLossEventsMap">
        <tr id="row35">
            <td>
                <div style="display: block;">
                    <table cellpadding="6px">
                        <tr>
                            ...
                            <td class="lightgrey" style="color:#000066;"><label id="lblRolesAgreements"><fmt:message key="page.party.partyroles.label.partyroleslinkedtolossevent" /></label></td>
                        </tr>
                    </table>
                </div>
                <div id="obj35">
                    <table id="tblRoles" class="party-table" cellpadding="3px">
                        <tr>
                            ...
                            <td class="lightgrey" style="color:#000066;">
                                <label><fmt:message key="page.party.partyroles.label.lossevent" /></label>
                            </td>
                            <td class="lightgrey" style="color:#000066;">
                        ...
                        <c:forEach var="roles" items="${partyForm.partyRoleLossEventsMap}" varStatus="idx">
                            <c:set var="agreementNo" value="${roles.key.agreementNumber}" scope="session" />
                            <tr>
                                <c:url value="secure/claim/lossevent/find.do?method=.findAndDisplay" var="viewPartyRoleURL">
                                    <c:param name="externalReference" value="${roles.key.agreementNumber}"/>
                                </c:url>
