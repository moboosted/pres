...
<html:form action="/secure/account/accountmapping/update.do" styleId="updateForm" styleClass="form-horizontal">

  <input type="hidden" name="method" id="method" value="" />
  <html:hidden property="accountMappingObjectReference" />
    ...
    <div class="form-group">
        <div class="col-md-offset-2 col-md-10">
            <html:submit property="method" styleClass="btn btn-primary btn-sm" onclick="$('#method').val('.update');">
                <fmt:message key="page.updateaccountmapping.action.update"/>
      </html:submit>
