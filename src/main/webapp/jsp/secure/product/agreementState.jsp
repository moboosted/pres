...
<html:form action="/secure/product/agreementstate.do" styleId="updateAgreementStateForm" styleClass="form-horizontal">
    ...
    <div class="form-group">
        <div class="col-md-offset-2 col-md-10">
            <html:submit onclick="$('#method').val('.update');" styleClass="btn btn-primary btn-sm">
                <fmt:message key="page.agreementstate.action.update"/>
            </html:submit>
