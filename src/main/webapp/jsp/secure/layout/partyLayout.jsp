...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/party/tabcontent.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/party/focus.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/party/contact.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/party/changes.js"></script>
    ...
    <c:set var="tabNo" value="${sessionScope.partyForm.tabToChangeTo}" scope="page" />
    <%int tabNumber = (Integer) pageContext.getAttribute("tabNo");%>
    <body onload="expandtab('maintab', <%=tabNumber%>);">
